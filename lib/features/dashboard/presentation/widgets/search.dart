...
class SearchSection extends StatelessWidget {
  ...
  const SearchSection(BuildContext context, {super.key, required this.queryValue, required this.queryType});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<RemoteArticlesBloc>(
      create: (context) => sl<RemoteArticlesBloc>()..add(GetArticles(queryValue, queryType as ArticleQueryType)),
